...
5. Is there a shared resource written concurrently? Is it protected (`skills/engineering-standards/reference/concurrency.md`, `skills/engineering-standards/reference/data.md`)?
...
8. Is there a secret, key, or token in this diff? Remove it now. (`skills/engineering-standards/reference/security.md`)
